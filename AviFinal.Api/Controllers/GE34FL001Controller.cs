...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34FL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34FL001Controller> _logger;

        public GE34FL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34FL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34FL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34FL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34flinspect
                {
                ...
                // Bulk insert
                await _context.Ge34flinspects .AddRangeAsync(entities);
