...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36CF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36CF001Controller> _logger;

        public GE36CF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36CF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36CF001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36CF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36cfinspect
                {
                ...
                // Bulk insert
                await _context.Ge36cfinspects.AddRangeAsync(entities);
