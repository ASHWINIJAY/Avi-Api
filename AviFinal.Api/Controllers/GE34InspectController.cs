...
namespace AviAppFinal.Server.Controllers
{
    ...
    public class GE34InspectController : ControllerBase
    {
        ...
        public async Task<IActionResult> GetPartCost(string partId, string field)
        {
            ...
            try
            {
                var part = await _context.Ge34finalParts.FirstOrDefaultAsync(p => p.PartId == partId);
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34InspectDto> dtos)
        {
