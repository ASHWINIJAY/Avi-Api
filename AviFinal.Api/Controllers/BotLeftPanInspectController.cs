...
namespace AviFinal.Api.Controllers
{
    ...
    public class BotLeftPanInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public BotLeftPanInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class BotLeftRowModel
        {
        ...
        public class BotLeftFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<BotLeftRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] BotLeftFormModel model)
        {
            ...
            {
                var entity = new BotLeftPanInspect
                {
                ...
                _context.BotLeftPanInspects.Add(entity);
            }
