...
namespace AviFinal.Api.Controllers
{
    ...
    public class CoupGearInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public CoupGearInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class CoupGearRowModel
        {
        ...
        public class CoupGearFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<CoupGearRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] CoupGearFormModel model)
        {
            ...
            {
                var entity = new CoupGearInspect
                {
                ...
                _context.CoupGearInspects.Add(entity);
            }
