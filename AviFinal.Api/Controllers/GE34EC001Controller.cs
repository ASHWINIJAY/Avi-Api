...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34EC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34EC001Controller> _logger;

        public GE34EC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34EC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34EC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34EC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34ecinspect
                {
                ...
                // Bulk insert
                await _context.Ge34ecinspects.AddRangeAsync(entities);
