...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36EC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36EC001Controller> _logger;

        public GE36EC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36EC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36EC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36EC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36ecinspect
                {
                ...
                // Bulk insert
                await _context.Ge36ecinspects.AddRangeAsync(entities);
