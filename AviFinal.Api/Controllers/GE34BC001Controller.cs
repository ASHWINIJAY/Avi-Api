...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34BC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34BC001Controller> _logger;

        public GE34BC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34BC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34BC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34BC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34bcinspect
                {
                ...
                // Bulk insert
                await _context.Ge34bcinspects.AddRangeAsync(entities);
