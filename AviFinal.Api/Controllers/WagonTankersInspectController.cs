...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class WagonTankersInspectController : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<WagonTankersInspectController> _logger;

        public WagonTankersInspectController(AviDbContext context, IWebHostEnvironment env, ILogger<WagonTankersInspectController> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> UploadPhoto([FromForm] IFormFile file, [FromForm] string formId, [FromForm] string partType, [FromForm] string photoType, [FromForm] string wagonNumber, [FromForm] string wagonGroup)
        {
            ...
            try
            {
                string baseFolder = Path.Combine(_env.WebRootPath, "Tankers", formId.ToUpper());
                ...
                string relativePath = Path.Combine("Tankers", formId.ToUpper(), subFolder, fileName).Replace("\\", "/");
        ...
        public class WagonTankersInspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<WagonTankersInspectDto> dtos)
        {
