...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34BS001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34BS001Controller> _logger;

        public GE34BS001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34BS001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34BS001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34BS001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34bsinspect
                {
                ...
                // Bulk insert
                await _context.Ge34bsinspects.AddRangeAsync(entities);
