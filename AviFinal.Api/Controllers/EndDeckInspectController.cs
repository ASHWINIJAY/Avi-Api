...
namespace AviFinal.Api.Controllers
{
    ...
    public class EndDeckInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public EndDeckInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class EndDeckRowModel
        {
        ...
        public class EndDeckFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<EndDeckRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] EndDeckFormModel model)
        {
            ...
            foreach (var row in model.Rows)
            {
                ...
                _context.EndDeckInspects.Add(entity);
            }
