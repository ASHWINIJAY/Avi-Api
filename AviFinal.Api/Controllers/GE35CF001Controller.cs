...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35CF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35CF001Controller> _logger;

        public GE35CF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35CF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35CF001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35CF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35cfinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35cfinspects .AddRangeAsync(entities);
