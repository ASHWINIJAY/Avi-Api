...
namespace AviFinal.Api.Controllers
{
    ...
    public class BatSwitchInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public BatSwitchInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class BatSwitchRowModel
        {
        ...
        public class BatSwitchFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<BatSwitchRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] BatSwitchFormModel model)
        {
            ...
            {
                var entity = new BatSwitchInspect
                {
                ...
                _context.BatSwitchInspects.Add(entity);
            }
