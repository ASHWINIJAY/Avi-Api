...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18EE001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18EE001Controller> _logger;

        public E18EE001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18EE001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18EE001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18eeinspect
                {
                ...
                await _context.E18eeinspects.AddRangeAsync(entities);
    ...
    public class E18EE001InspectDto
    {
