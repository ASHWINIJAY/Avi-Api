...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35DE001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35DE001Controller> _logger;

        public GE35DE001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35DE001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35DE001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35DE001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35deinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35deinspects .AddRangeAsync(entities);
