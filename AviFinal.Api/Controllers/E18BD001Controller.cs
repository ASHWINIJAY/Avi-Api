...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18BD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18BD001Controller> _logger;

        public E18BD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18BD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18BDInspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18bdinspect
                {
                ...
                // Bulk insert
                await _context.E18bdinspects.AddRangeAsync(entities);
