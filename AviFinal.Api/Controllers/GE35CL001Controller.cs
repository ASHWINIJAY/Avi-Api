...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35CL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35CL001Controller> _logger;

        public GE35CL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35CL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35CL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35CL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35clinspect
                {
                ...
                // Bulk insert
                await _context.Ge35clinspects .AddRangeAsync(entities);
