...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35BS001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35BS001Controller> _logger;

        public GE35BS001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35BS001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35BS001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35BS001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35bsinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35bsinspects .AddRangeAsync(entities);
