...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34RF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34RF001Controller> _logger;

        public GE34RF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34RF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34RF001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34RF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34rfinspect 
                {
                ...
                // Bulk insert
                await _context.Ge34rfinspects .AddRangeAsync(entities);
