...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18HV001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18HV001Controller> _logger;

        public E18HV001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18HV001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18HV001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18hvinspect
                {
                ...
                await _context.E18hvinspects.AddRangeAsync(entities);
    ...
    public class E18HV001InspectDto
    {
