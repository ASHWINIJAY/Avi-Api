...
namespace AviAppFinal.Server.Controllers
{
    ...
    public class GM34InspectController : ControllerBase
    {
        ...
        private readonly ILogger<GM34InspectController> _logger;
        private readonly string _connectionString;

        public GM34InspectController(AviDbContext context, IWebHostEnvironment env, ILogger<GM34InspectController> logger, IConfiguration config)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> GetPartCost(string partId, string field)
        {
            ...
            var part = await _context.Gm34finalParts.FirstOrDefaultAsync(p => p.PartId == partId);
        ...
        public async Task<IActionResult> UploadPhoto([FromForm] IFormFile file, [FromForm] string formId, [FromForm] string partId, [FromForm] string photoType, [FromForm] string locoNumber, [FromForm] string locoModel)
        {
            ...
            try
            {
                string baseFolder = Path.Combine(_env.WebRootPath, "GM34", formId.ToUpper());
                ...
                string relative = Path.Combine("GM34", formId.ToUpper(), subFolder, fileName).Replace("\\", "/");
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GM34InspectDto> dtos)
        {
            ...
            {
                "BD001" => "Gm34bdinspects",
                "FL001" => "Gm34flinspects",
                "SN001" => "Gm34sninspects",
                "CL001" => "Gm34clinspects",
                "EL001" => "Gm34elinspects",
                "BS001" => "Gm34bsinspects",
                "LM001" => "Gm34lminspects",
                "CB001" => "Gm34cbinspects",
                "TR001" => "Gm34trinspects",
                "MP001" => "Gm34mpinspects",
                "BL001" => "Gm34blinspects",
                "CA001" => "Gm34cainspects",
                "ED001" => "Gm34edinspects",
                "CF001" => "Gm34cfinspects",
                "DE001" => "Gm34deinspects",
                "RF001" => "Gm34rfinspects",
                _ => null
            };
