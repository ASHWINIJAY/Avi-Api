...
namespace AviFinal.Api.Controllers
{
    ...
    public class LeftMidDoorInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public LeftMidDoorInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class LeftMidRowModel
        {
        ...
        public class LeftMidFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<LeftMidRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] LeftMidFormModel model)
        {
            ...
            {
                var entity = new LeftMidDoorInspect
                {
                ...
                _context.LeftMidDoorInspects.Add(entity);
            }
