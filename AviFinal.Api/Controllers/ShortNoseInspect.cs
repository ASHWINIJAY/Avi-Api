...
namespace AviFinal.Api.Controllers
{
    ...
    public class ShortNoseInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public ShortNoseInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class ShortNoseRowModel
        {
        ...
        public class ShortNoseFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<ShortNoseRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] ShortNoseFormModel model)
        {
            ...
            {
                var entity = new ShortNoseInspect
                {
                ...
                _context.ShortNoseInspects.Add(entity);
            }
