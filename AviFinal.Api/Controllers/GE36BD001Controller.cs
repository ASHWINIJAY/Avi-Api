...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36BD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36BD001Controller> _logger;

        public GE36BD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36BD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36BD001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36BD001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36bdinspect
                {
                ...
                // Bulk insert
                await _context.Ge36bdinspects.AddRangeAsync(entities);
