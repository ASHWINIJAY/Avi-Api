...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35BC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35BC001Controller> _logger;

        public GE35BC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35BC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35BC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35BC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35bcinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35bcinspects .AddRangeAsync(entities);
