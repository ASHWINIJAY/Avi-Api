...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18HC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18HC001Controller> _logger;

        public E18HC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18HC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18HC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18hcinspect
                {
                ...
                await _context.E18hcinspects.AddRangeAsync(entities);
    ...
    public class E18HC001InspectDto
    {
