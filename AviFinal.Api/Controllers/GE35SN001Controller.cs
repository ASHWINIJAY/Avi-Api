...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35SN001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35SN001Controller> _logger;

        public GE35SN001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35SN001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35SN001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35SN001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35sninspect
                {
                ...
                // Bulk insert
                await _context.Ge35sninspects.AddRangeAsync(entities);
