...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35MG001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35MG001Controller> _logger;

        public GE35MG001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35MG001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35MG001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35MG001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35mginspect
                {
                ...
                // Bulk insert
                await _context.Ge35mginspects .AddRangeAsync(entities);
