...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18CT001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18CT001Controller> _logger;

        public E18CT001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18CT001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18CT001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18ctinspect
                {
                ...
                await _context.E18ctinspects.AddRangeAsync(entities);
    ...
    public class E18CT001InspectDto
    {
