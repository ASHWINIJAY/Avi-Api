...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36FL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36FL001Controller> _logger;

        public GE36FL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36FL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36FL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36FL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36flinspect
                {
                ...
                // Bulk insert
                await _context.Ge36flinspects.AddRangeAsync(entities);
