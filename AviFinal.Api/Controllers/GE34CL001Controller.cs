...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34CL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34CL001Controller> _logger;

        public GE34CL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34CL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34CL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34CL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34clinspect
                {
                ...
                // Bulk insert
                await _context.Ge34clinspects.AddRangeAsync(entities);
