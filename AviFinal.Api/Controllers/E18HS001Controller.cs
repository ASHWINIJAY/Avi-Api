...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18HS001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18HS001Controller> _logger;

        public E18HS001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18HS001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18HS001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18hsinspect
                {
                ...
                await _context.E18hsinspects.AddRangeAsync(entities);
    ...
    public class E18HS001InspectDto
    {
