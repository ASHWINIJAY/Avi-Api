...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18LV001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18LV001Controller> _logger;

        public E18LV001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18LV001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18LV001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18lvinspect
                {
                ...
                await _context.E18lvinspects.AddRangeAsync(entities);
    ...
    public class E18LV001InspectDto
    {
