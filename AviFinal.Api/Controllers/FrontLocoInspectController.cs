...
namespace AviFinal.Api.Controllers
{
    ...
    public class FrontLocoInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public FrontLocoInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class FrontLocoRowModel
        {
        ...
        public class FrontLocoFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<FrontLocoRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] FrontLocoFormModel model)
        {
            ...
            {
                var entity = new FrontLocoInspect
                {
                ...
                _context.FrontLocoInspects.Add(entity);
            }
            ...
            return Ok(new { message = "Front Loco Inspect submitted successfully." });
        }
    }
}
