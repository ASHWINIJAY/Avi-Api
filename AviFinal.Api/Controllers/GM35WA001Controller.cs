...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class GM35WA001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GM35WA001Controller> _logger;

        public GM35WA001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GM35WA001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> UploadPhoto([FromForm] IFormFile file, [FromForm] string formId, [FromForm] string partId, [FromForm] string photoType, [FromForm] string locoNumber, [FromForm] string locoModel)
        {
            ...
            try
            {
                // Base folder: wwwroot/GM35/BD001
                ...
                string relativePath = Path.Combine("GM35", formId.ToUpper(), subFolder, fileName).Replace("\\", "/");
        ...
        public IActionResult DeletePhoto([FromBody] DeletePhotoRequest5 request)
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GM35WAInspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Gm35wainspect
                {
                ...
                // Bulk insert
                await _context.Gm35wainspects.AddRangeAsync(entities);
    ...
    public class DeletePhotoRequest5
    {
    public string Path { get; set; } = string.Empty;
    }
    
    public class GM35WAInspectDto
    {
