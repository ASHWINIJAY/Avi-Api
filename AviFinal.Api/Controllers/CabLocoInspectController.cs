...
namespace AviFinal.Api.Controllers
{
    ...
    public class CabLocoInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public CabLocoInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class CabLocoRowModel
        {
        ...
        public class CabLocoFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<CabLocoRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] CabLocoFormModel model)
        {
            ...
            foreach (var row in model.Rows)
            {
                ...
                _context.CabLocoInspects.Add(entity);
            }
