...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36CA001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36CA001Controller> _logger;

        public GE36CA001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36CA001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36CA001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36CA001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36cainspect
                {
                ...
                // Bulk insert
                await _context.Ge36cainspects.AddRangeAsync(entities);
