...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35OD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35OD001Controller> _logger;

        public GE35OD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35OD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35OD001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35OD001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35odinspect
                {
                ...
                // Bulk insert
                await _context.Ge35odinspects.AddRangeAsync(entities);
