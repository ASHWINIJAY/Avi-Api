...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18RF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18RF001Controller> _logger;

        public E18RF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18RF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18RF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18rfinspect
                {
                ...
                await _context.E18rfinspects.AddRangeAsync(entities);
    ...
    public class E18RF001InspectDto
    {
