...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34SN001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34SN001Controller> _logger;

        public GE34SN001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34SN001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34SN001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34SN001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34sninspect 
                {
                ...
                // Bulk insert
                await _context.Ge34sninspects .AddRangeAsync(entities);
