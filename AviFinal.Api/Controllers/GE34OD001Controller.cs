...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34OD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34OD001Controller> _logger;

        public GE34OD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34OD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34OD001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34OD001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34odinspect
                {
                ...
                // Bulk insert
                await _context.Ge34odinspects.AddRangeAsync(entities);
