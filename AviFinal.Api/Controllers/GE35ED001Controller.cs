...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35ED001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35ED001Controller> _logger;

        public GE35ED001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35ED001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35ED001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35ED001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35edinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35edinspects .AddRangeAsync(entities);
