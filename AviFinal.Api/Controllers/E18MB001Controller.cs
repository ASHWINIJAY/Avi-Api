...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18MB001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18MB001Controller> _logger;

        public E18MB001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18MB001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18MB001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18mbinspect
                {
                ...
                await _context.E18mbinspects.AddRangeAsync(entities);
    ...
    public class E18MB001InspectDto
    {
