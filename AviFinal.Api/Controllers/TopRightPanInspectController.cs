...
namespace AviFinal.Api.Controllers
{
    ...
    public class TopRightPanInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public TopRightPanInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class TopRightRowModel
        {
        ...
        public class TopRightFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<TopRightRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] TopRightFormModel model)
        {
            ...
            {
                var entity = new TopRightPanInspect
                {
                ...
                _context.TopRightPanInspects.Add(entity);
            }
