...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34BD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34BD001Controller> _logger;

        public GE34BD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34BD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34BD001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34BD001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34bdinspect
                {
                ...
                // Bulk insert
                await _context.Ge34bdinspects.AddRangeAsync(entities);
