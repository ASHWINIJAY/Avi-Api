...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34AC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34AC001Controller> _logger;

        public GE34AC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34AC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34AC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34AC001InspectDto> dtos)
        {
