...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35FL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35FL001Controller> _logger;

        public GE35FL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35FL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35FL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35FL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35flinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35flinspects .AddRangeAsync(entities);
