...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class GM36WA001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GM36WA001Controller> _logger;

        public GM36WA001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GM36WA001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> UploadPhoto([FromForm] IFormFile file, [FromForm] string formId, [FromForm] string partId, [FromForm] string photoType, [FromForm] string locoNumber, [FromForm] string locoModel)
        {
            ...
            try
            {
                // Base folder: wwwroot/GM36/BD001
                ...
                string relativePath = Path.Combine("GM36", formId.ToUpper(), subFolder, fileName).Replace("\\", "/");
        ...
        public IActionResult DeletePhoto([FromBody] DeletePhotoRequest6 request)
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GM36WAInspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Gm36wainspect
                {
                ...
                // Bulk insert
                await _context.Gm36wainspects.AddRangeAsync(entities);
    ...
    public class DeletePhotoRequest6
    {
    public string Path { get; set; } = string.Empty;
    }
    
    public class GM36WAInspectDto
    {
