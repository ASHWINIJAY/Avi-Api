...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18CR001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18CR001Controller> _logger;

        public E18CR001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18CR001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18CR001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18crinspect
                {
                ...
                await _context.E18crinspects.AddRangeAsync(entities);
    ...
    public class E18CR001InspectDto
    {
