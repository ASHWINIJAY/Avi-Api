...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36MG001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36MG001Controller> _logger;

        public GE36MG001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36MG001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36MG001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36MG001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36mginspect
                {
                ...
                // Bulk insert
                await _context.Ge36mginspects.AddRangeAsync(entities);
