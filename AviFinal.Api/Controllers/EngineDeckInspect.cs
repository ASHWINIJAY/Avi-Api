...
namespace AviFinal.Api.Controllers
{
    ...
    public class EngineDeckInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public EngineDeckInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class EngineDeckRowModel
        {
        ...
        public class EngineDeckFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<EngineDeckRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] EngineDeckFormModel model)
        {
            ...
            {
                var entity = new EngineDeckInspect
                {
                ...
                _context.EngineDeckInspects.Add(entity);
            }
