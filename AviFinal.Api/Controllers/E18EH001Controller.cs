...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18EH001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18EH001Controller> _logger;

        public E18EH001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18EH001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18EH001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18ehinspect
                {
                ...
                await _context.E18ehinspects.AddRangeAsync(entities);
    ...
    public class E18EH001InspectDto
    {
