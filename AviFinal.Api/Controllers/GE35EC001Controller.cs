...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35EC001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35EC001Controller> _logger;

        public GE35EC001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35EC001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35EC001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35EC001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35ecinspect 
                {
                ...
                // Bulk insert
                await _context.Ge35ecinspects .AddRangeAsync(entities);
