...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18MA001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18MA001Controller> _logger;

        public E18MA001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18MA001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18MA001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18mainspect
                {
                ...
                await _context.E18mainspects.AddRangeAsync(entities);
    ...
    public class E18MA001InspectDto
    {
