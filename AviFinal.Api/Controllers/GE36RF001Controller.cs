...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36RF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36RF001Controller> _logger;

        public GE36RF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36RF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36RF001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36RF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36rfinspect
                {
                ...
                // Bulk insert
                await _context.Ge36rfinspects.AddRangeAsync(entities);
