...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34DE001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34DE001Controller> _logger;

        public GE34DE001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34DE001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34DE001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34DE001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34deinspect
                {
                ...
                // Bulk insert
                await _context.Ge34deinspects.AddRangeAsync(entities);
