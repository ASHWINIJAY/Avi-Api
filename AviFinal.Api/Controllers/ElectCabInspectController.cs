...
namespace AviFinal.Api.Controllers
{
    ...
    public class ElectCabInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public ElectCabInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class ElectCabRowModel
        {
        ...
        public class ElectCabFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<ElectCabRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] ElectCabFormModel model)
        {
            ...
            {
                var entity = new ElectCabInspect
                {
                ...
                _context.ElectCabInspects.Add(entity);
            }
