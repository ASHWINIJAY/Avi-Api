...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36CL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36CL001Controller> _logger;

        public GE36CL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36CL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36CL001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36CL001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36clinspect
                {
                ...
                // Bulk insert
                await _context.Ge36clinspects.AddRangeAsync(entities);
