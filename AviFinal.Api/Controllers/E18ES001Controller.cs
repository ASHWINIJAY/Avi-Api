...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18ES001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18ES001Controller> _logger;

        public E18ES001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18ES001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18ES001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18esinspect
                {
                ...
                await _context.E18esinspects.AddRangeAsync(entities);
    ...
    public class E18ES001InspectDto
    {
