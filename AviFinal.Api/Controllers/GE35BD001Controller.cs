...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE35BD001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE35BD001Controller> _logger;

        public GE35BD001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE35BD001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE35BD001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE35BD001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge35bdinspect
                {
                ...
                // Bulk insert
                await _context.Ge35bdinspects.AddRangeAsync(entities);
