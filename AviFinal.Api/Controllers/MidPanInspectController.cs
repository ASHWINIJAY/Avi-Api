...
namespace AviFinal.Api.Controllers
{
    ...
    public class MidPanInspectController : ControllerBase
    {
        private readonly AviDbContext _context;

        public MidPanInspectController(AviDbContext context)
        {
            _context = context;
        }

        public class MidPanRowModel
        {
        ...
        public class MidPanFormModel
        {
            public int LocoNumber { get; set; }
            public string UserID { get; set; } = null!;
            public string InspectFormID { get; set; } = null!;
            public List<MidPanRowModel> Rows { get; set; } = new();
        }

        [HttpPost("submit")]
        public async Task<IActionResult> SubmitForm([FromBody] MidPanFormModel model)
        {
            ...
            foreach (var row in model.Rows)
            {
                ...
                _context.MidPanInspects.Add(entity);
            }
