...
namespace AviFinal.Api.Controllers
{
    ...
    [ApiController]
    public class E18FL001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<E18FL001Controller> _logger;

        public E18FL001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<E18FL001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<E18FLInspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new E18flinspect
                {
                ...
                // Bulk insert
                await _context.E18flinspects.AddRangeAsync(entities);
