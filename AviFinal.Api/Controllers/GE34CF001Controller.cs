...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34CF001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34CF001Controller> _logger;

        public GE34CF001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34CF001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public async Task<IActionResult> UploadPhoto([FromForm] IFormFile file, [FromForm] string formId, [FromForm] string partId, [FromForm] string photoType, [FromForm] string locoNumber, [FromForm] string locoModel)
        {
            ...
            try
            {
                string baseFolder = Path.Combine(_env.WebRootPath, "GE34", formId.ToUpper());
                ...
                string relativePath = Path.Combine("GE34", formId.ToUpper(), subFolder, fileName).Replace("\\", "/");
        ...
        public class GE34CF001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34CF001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34cfinspect
                {
                ...
                // Bulk insert
                await _context.Ge34cfinspects.AddRangeAsync(entities);
