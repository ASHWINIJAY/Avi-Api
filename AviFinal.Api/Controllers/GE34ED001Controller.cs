...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE34ED001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE34ED001Controller> _logger;

        public GE34ED001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE34ED001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE34ED001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE34ED001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge34edinspect 
                {
                ...
                // Bulk insert
                await _context.Ge34edinspects .AddRangeAsync(entities);
