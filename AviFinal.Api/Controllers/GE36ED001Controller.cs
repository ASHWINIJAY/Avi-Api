...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36ED001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36ED001Controller> _logger;

        public GE36ED001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36ED001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36ED001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36ED001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36edinspect
                {
                ...
                // Bulk insert
                await _context.Ge36edinspects.AddRangeAsync(entities);
