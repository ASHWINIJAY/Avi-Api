...
namespace AviAppFinal.Server.Controllers
{
    ...
    [ApiController]
    public class GE36DE001Controller : ControllerBase
    {
        private readonly AviDbContext _context;
        private readonly IWebHostEnvironment _env;
        private readonly ILogger<GE36DE001Controller> _logger;

        public GE36DE001Controller(AviDbContext context, IWebHostEnvironment env, ILogger<GE36DE001Controller> logger)
        {
            _context = context;
            _env = env;
            _logger = logger;
        ...
        public class GE36DE001InspectDto
        {
        ...
        public async Task<IActionResult> SubmitInspection([FromBody] List<GE36DE001InspectDto> dtos)
        {
            ...
            try
            {
                var entities = dtos.Select(d => new Ge36deinspect
                {
                ...
                // Bulk insert
                await _context.Ge36deinspects.AddRangeAsync(entities);
